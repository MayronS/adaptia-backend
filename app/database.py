...
# ── NullPool: obrigatório para bancos serverless como Neon ────────────────────
# Neon hiberna o endpoint após inatividade e fecha conexões TCP abruptamente.
# Pool persistente (pool_size > 0) mantém conexões "abertas" que na prática
# estão mortas após o cold start, causando erros mesmo com pool_pre_ping.
# NullPool abre uma conexão nova a cada request e fecha ao terminar —
# é o comportamento correto para ambientes serverless.
